const zh = {
  ...
  approval: {
    ...
    rootWarningText: '请核对命令和目标主机。', sourceHost: '源主机', targetHost: '目标主机', identity: '执行身份', environment: '运行环境',
    hostShell: '宿主机', deadline: '审批截止', digest: '请求摘要', sourceSHA: '源 SHA256', destinationSHA: '目标 SHA256', unboundVersion: '未校验文件版本',
  ...
  toolNames: {
    ...
    ssh_file_write: '事务写入远程文件', ssh_file_apply_patch: '事务应用远程补丁', ssh_file_transfer: '在主机间传输文件', ssh_config_apply: '应用远程配置事务', ssh_config_restore: '恢复远程配置备份',
