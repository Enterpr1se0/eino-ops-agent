const zh = {
  ...
  tool: {
    ...
    fullScript: '完整脚本', fullCommand: '完整命令', fullTransaction: '完整修改', originalArgs: 'ARGV · 原始参数', environment: '环境变量',
    ...
    rawJson: '原始 JSON', fileEvidence: '文件变更', bytesRead: '读取大小', validated: '校验通过', mode: '权限模式', owner: '所有者', validator: '校验器', operationId: '操作 ID', before: '修改前', after: '修改后', backup: '备份', index: '序号', key: '键', value: '值', stderrResult: 'STDERR / 结果', sensitive: '敏感内容已脱敏，请勿用占位内容覆盖原文件。',
    emptyResult: '工具执行完成。',
  },
  approval: {
  ...
  toolNames: {
    ssh_exec: '执行远程命令', ssh_run_script: '执行 Bash 脚本', ssh_file_read: '读取远程文件', ssh_file_search: '搜索远程文件', ssh_file_list: '列出远程目录',
    ssh_file_edit: '编辑远程文件', ssh_file_transfer: '在主机间传输文件', ssh_file_restore: '恢复远程文件',
    ssh_task: '管理后台任务', ssh_host_list: '列出主机', ssh_host_inspect: '检查主机',
    workspace_list: '列出 Workspace', workspace_file_list: '列出 Workspace 目录', workspace_file_read: '读取 Workspace 文件', workspace_file_search: '搜索 Workspace 文件', workspace_file_edit: '编辑 Workspace 文件',
