const en = {
  ...
  tool: {
    ...
    targetHost: 'Target host', sourceFile: 'Source file', filePath: 'File path', workingDirectory: 'Working directory', defaultDirectory: 'Default directory',
  ...
  approval: {
    ...
    uploadTitle: 'Allow this file upload?', hostShellTitle: 'Allow this script to run on the host?', fileTitle: 'Allow this file change?', executeTitle: 'Allow this {{kind}} to run?',
    uploadLabel: 'File to upload', rootFileLabel: 'File to modify as root', rootCommandLabel: 'Full {{kind}} to execute as root', fileLabel: 'File to modify', commandLabel: 'Full {{kind}} to execute',
    ...
    rootWarningText: 'Check the command and target host.', targetHost: 'Target host', identity: 'Run as', environment: 'Environment',
    hostShell: 'Host', deadline: 'Deadline', digest: 'Request digest', unboundVersion: 'File version not checked',
