...
产物分别位于 `web/src-tauri/target/release/bundle/nsis/` 和 `web/src-tauri/target/release/bundle/{appimage,deb}/`。推送 `v*` 标签或手动运行 `Desktop packages` 工作流也会生成 Windows x64 与 Linux x64 安装包。
